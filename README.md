...
Este repositório foi criado para documentar toda a minha jornada de aprendizado na linguagem Python. Aqui, centralizo exercícios, anotações teóricas e pequenos projetos práticos seguindo um cronograma de estudos completo.
...
[✅] Python Syntax - A importância da indentação e estrutura básica.

[✅] Python Output - Como exibir dados no console (print).
...
[✅] Python Numbers - Int, float e complex.
...
[ ] Python Modules - Como importar e criar módulos.
...
[ ] Python PIP - Gerenciamento de pacotes externos.

[ ] Python Try...Except - Tratamento de erros e exceções.

[ ] Python User Input - Interação com o usuário via terminal.

[ ] Python VirtualEnv - Isolamento de ambientes de desenvolvimento.
